...
|  | SEClust-Auto | 0.471 | 0.510 | 0.314 | 6 | 0.342 | **3.427** | 4.612 | 0.1196 | 0.4 | ok |
|  | SEClust-Tree | **0.971** | 0.836 | **0.882** | 2 | **0.357** | 3.849 | **4.464** | 0.0555 | 0.2 | ok |
...
|  | SEClust-Auto | **1.000** | **1.000** | **1.000** | 10 | **0.895** | **4.337** | **4.380** | 0.6307 | 4.6 | ok |
|  | SEClust-Tree | **1.000** | **1.000** | **1.000** | 10 | **0.895** | **4.337** | **4.380** | 0.2933 | 4.1 | ok |
...
|  | SEClust-Auto | 0.720 | 0.850 | 0.731 | 7 | 0.513 | 4.849 | 5.815 | 0.2007 | 0.9 | ok |
|  | SEClust-Tree | **1.000** | **1.000** | **1.000** | 4 | **0.626** | **4.840** | **5.399** | 0.3191 | 2.0 | ok |
...
|  | SEClust-Auto | 0.936 | 0.945 | 0.931 | 9 | 0.582 | 7.073 | 7.874 | 5.3507 | 11.0 | ok |
|  | SEClust-Tree | **1.000** | **1.000** | **1.000** | 5 | **0.629** | **7.016** | **7.717** | 6.3074 | 11.0 | ok |
...
|  | SEClust-Auto | 0.944 | 0.968 | 0.947 | 14 | 0.561 | 7.676 | 8.762 | 11.1665 | 18.4 | ok |
|  | SEClust-Tree | **1.000** | **1.000** | **1.000** | 10 | **0.589** | **7.635** | **8.671** | 13.7670 | 18.5 | ok |
...
|  | SEClust-Auto | skip | skip | skip | skip | skip | skip | skip | skip | unavailable: torch_geometric datasets are not installed locally |
|  | SEClust-Tree | skip | skip | skip | skip | skip | skip | skip | skip | unavailable: torch_geometric datasets are not installed locally |
...
- Skipped or unavailable SEClust runs: `4`.
